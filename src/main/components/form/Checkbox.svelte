<script lang="ts">
    ...
    let styleClass = `border data-[state=checked]:bg-${colorVariant} h-[.65lh] w-[.65lh] shrink-0 rounded-sm disabled:cursor-not-allowed disabled:opacity-50 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50`;
