...
<DialogPrimitive.Root bind:open>
    ...
    <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content {id} data-testid={testId} class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 max-w-[94%] rounded-lg bg-surface px-8 py-2">
